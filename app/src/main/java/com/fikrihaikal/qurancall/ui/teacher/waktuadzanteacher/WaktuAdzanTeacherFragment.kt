package com.fikrihaikal.qurancall.ui.teacher.waktuadzanteacher
...
import com.fikrihaikal.qurancall.databinding.FragmentWaktuAdzanTeacherBinding
...
class WaktuAdzanTeacherFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWaktuAdzanTeacherBinding.inflate(inflater,container,false)
        return binding.root
    }
        ...
        binding.autoCompleteTextView.addTextChangedListener(object :TextWatcher{
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if (s.toString().isNotEmpty()){
                    adzanTeacherViewModel.searchCities(s.toString())
                }
            }
